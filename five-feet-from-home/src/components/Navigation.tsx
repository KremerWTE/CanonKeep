...
function GitBranchIcon({ className }: { className?: string }) {
  return (
    <svg className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor">
      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M6 3v12M6 3l4 4M6 3l-4 4m12 6v6M18 9a3 3 0 100-6 3 3 0 000 6zm-12 6a3 3 0 100 6 3 3 0 000 6" />
    </svg>
  );
}
...
const navItems = [
  ...
  { href: '/chapters', label: 'Chapters', icon: BookOpenIcon },
  { href: '/plots', label: 'Plot Threads', icon: GitBranchIcon },
  ...
  { href: '/continuity', label: 'Continuity', icon: AlertIcon },
  { href: '/builder', label: 'Book Builder', icon: WrenchIcon },
